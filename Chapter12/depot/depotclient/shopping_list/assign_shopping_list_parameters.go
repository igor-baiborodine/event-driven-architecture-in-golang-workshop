...
type AssignShoppingListParams struct {
	...
	// Body.
	Body *models.DepotServiceAssignShoppingListBody
...
func (o *AssignShoppingListParams) WithBody(body *models.DepotServiceAssignShoppingListBody) *AssignShoppingListParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the assign shopping list params
func (o *AssignShoppingListParams) SetBody(body *models.DepotServiceAssignShoppingListBody) {
	o.Body = body
}
