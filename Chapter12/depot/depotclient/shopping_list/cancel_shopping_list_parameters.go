...
type CancelShoppingListParams struct {
	...
	// Body.
	Body models.DepotpbDepotServiceCancelShoppingListBody
...
func (o *CancelShoppingListParams) WithBody(body models.DepotpbDepotServiceCancelShoppingListBody) *CancelShoppingListParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the cancel shopping list params
func (o *CancelShoppingListParams) SetBody(body models.DepotpbDepotServiceCancelShoppingListBody) {
	o.Body = body
}
