...
type PayInvoiceParams struct {
	...
	// Body.
	Body models.PaymentsServicePayInvoiceBody
...
func (o *PayInvoiceParams) WithBody(body models.PaymentsServicePayInvoiceBody) *PayInvoiceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the pay invoice params
func (o *PayInvoiceParams) SetBody(body models.PaymentsServicePayInvoiceBody) {
	o.Body = body
}
