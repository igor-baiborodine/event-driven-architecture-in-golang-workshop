...
func (o *CcompleteShoppingListParams) WithBody(body models.DepotServiceCompleteShoppingListBody) *CcompleteShoppingListParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the ccomplete shopping list params
func (o *CcompleteShoppingListParams) SetBody(body models.DepotServiceCompleteShoppingListBody) {
	o.Body = body
}
